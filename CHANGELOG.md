...
### 🚀 Added & Changed
- **Recursive Directory Processing (`--recursive`)**: You can now process entire media libraries at once. The CLI deeply traverses subdirectories and seamlessly mirrors the exact original folder architecture in the output destination.
